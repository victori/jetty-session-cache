...
public class EhMemcachedSessionManager2 extends MemcachedSessionManager {
	private static final int DEFAULT_TTL = 1800; // 30 minutes..
	private int localttl = DEFAULT_TTL;
	private boolean async = true;

	public EhMemcachedSessionManager2(final String[] servers, final String poolName) {
		this(servers, poolName,DEFAULT_TTL);
	}

	public EhMemcachedSessionManager2(final String[] servers, final String poolName,final int localttl) {
	...
	protected IDistributedCache newClient(final String poolName) {
		return new AsyncMemcache(getServers(),poolName,isAsync(),getLocalttl());
	}
